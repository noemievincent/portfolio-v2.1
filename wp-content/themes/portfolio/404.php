<?php get_header() ?>
    ...
    <div id="404-page"
        ...
        <div class="col-span-full md:col-start-1 md:col-span-4 rl:col-start-2 rl:col-span-5 lg:col-start-3 lg:col-span-4 2xl:col-start-4 2xl:col-span-3 md:pr-10 rl:pr-14 text-xl text-theme-dark">
        ...
        <div class="col-span-full md:col-end-9 md:col-span-4 rl:col-end-12 rl:col-span-5 lg:col-end-11 lg:col-span-4 2xl:col-end-10 2xl:col-span-3 self-center flex flex-col gap-10 rl:gap-14 max-md:h-full max-md:flex-grow justify-between">
