...
<div id="<?= $section_id ?>"
     class="page-section bg-white grid-default px-default py-10 pb-24 md:py-12 md:pb-32 xl:py-24 xl:pb-48 2xl:pb-80">
    <div class="col-span-full rg:col-start-1 rg:col-span-5 rl:col-start-1 rl:col-span-6 xl:col-start-2 xl:col-span-5 2xl:col-start-3 2xl:col-span-4 rg:py-10 xl:py-18 flex flex-col gap-8 lg:gap-16">
        ...
        <?php if ($btn_1 || $btn_2) : ?>
            <div class="flex items-center max-md:justify-center flex-wrap gap-6 md:gap-10 xl:gap-14">
                <?php if ($btn_1) : ?>
    ...
    <div class="col-span-full rg:col-end-9 rg:col-span-3 rl:col-end-13 rl:col-span-5 xl:col-end-12 xl:col-span-4 2xl:col-end-11 2xl:col-span-3 max-rg:hidden rg:max-rl:-ml-16">
