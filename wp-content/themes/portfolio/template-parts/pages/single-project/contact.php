...
<section aria-labelledby="contact" class="relative grid-default px-default bg-theme-light">
    <div class="col-span-full md:col-start-1 md:col-span-4 rl:-col-start-1 rl:col-span-6 xl:col-start-2 xl:col-span-4 2xl:col-start-3 2xl:col-span-3 flex flex-col gap-8 lg:gap-14 py-6 pb-12 lg:pt-8">
    ...
    <div class="max-md:hidden col-span-full md:col-end-9 md:col-span-3 rl:col-end-13 rl:col-span-5 xl:col-end-12 xl:col-span-5 2xl:col-end-11 2xl:col-span-4 md:pb-6 lg:pb-16">
