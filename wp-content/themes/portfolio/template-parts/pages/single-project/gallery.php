...
if (!empty($images)) :
    ...
    <section aria-labelledby="gallery"
        ...
        <div class="relative grid-default px-default overflow-hidden">
            <div class="col-span-full lg:col-start-2 lg:col-span-10 2xl:col-start-3 2xl:col-span-8 py-12 pb-24 md:pb-36 rg:py-20 rg:pb-40 lg:py-20 lg:pb-64 gap-y-12">
